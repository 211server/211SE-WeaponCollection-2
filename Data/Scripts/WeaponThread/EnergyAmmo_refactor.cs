...
{ // Don't edit above this line
    partial class Weapons //XB1BeamCharge
    {
        private AmmoDef XB1BeamCharge => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "XB1BeamCharge",
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 1f,
                        Width = 0.05f,
                        Color = Color(red: 20, green: 10, blue: 10, alpha: 1),
                        VisualFadeStart = 270, // Number of ticks the weapon has been firing before projectiles begin to fade their color
        ...
        private AmmoDef XB3BeamCharge => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "XB3BeamCharge",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 1.0f,// 1.0f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel 1.25f
            BaseDamage = 120f,
            Mass = 0.0f, // in kilograms
            Health = 0, // 0 = disabled, otherwise how much damage it can take from other trajectiles before dying.
            BackKickForce = 0f,
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Width = 0.05f,
                        Color = Color(red: 10, green: 2, blue: 0, alpha: 1),
                        VisualFadeStart = 540, // Number of ticks the weapon has been firing before projectiles begin to fade their color
        ...
        private AmmoDef EX1BeamCharge => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "EX1BeamCharge",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 1.0f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel 1.25f
            BaseDamage = 120f,
            Mass = 0.0f, // in kilograms
            Health = 0, // 0 = disabled, otherwise how much damage it can take from other trajectiles before dying.
            BackKickForce = 0f,
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    Hit = new ParticleDef
                    {
                        ...
                        ApplyToShield = true,
                        ShrinkByDistance = true,
                        Color = Color(red: 200, green: 120, blue: 0, alpha: 1),
                        Offset = Vector(x: 0, y: 0, z: 0),
                        Extras = new ParticleOptionDef
                        {
                            Loop = false,
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 1f,
                        Width = 0.05f,
                        Color = Color(red: 20, green: 10, blue: 10, alpha: 0),
                        VisualFadeStart = 270, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 300, // How many ticks after fade began before it will be invisible.
                    },
                    Trail = new TrailDef
                    {
                        ...
                        Material = "WeaponLaser",
                        DecayTime = 1,
                        Color = Color(red: 40, green: 10, blue: 10, alpha: 1),
                        Back = false,
                        CustomWidth = 0.10f,
                        UseWidthVariance = true,
                        UseColorFade = true,
                    ...
                    OffsetEffect = new OffsetEffectDef
                    {
                        MaxOffset = 0.15f,// 0 offset value disables this effect
                        MinLength = 5f,
                        MaxLength = 10f,
                    },
                },
        ...
        private AmmoDef EX1BeamChargeExtra => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "EX1BeamChargeExtra",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel 1.25f
            BaseDamage = 0f,
            Mass = 0.0f, // in kilograms
            Health = 0, // 0 = disabled, otherwise how much damage it can take from other trajectiles before dying.
            BackKickForce = 0f,
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    Hit = new ParticleDef
                    {
                        ...
                        Color = Color(red: 100, green: 1, blue: 0, alpha: 2),
                        Offset = Vector(x: 0, y: 0, z: 0),
                        Extras = new ParticleOptionDef
                        {
                            Loop = false,
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 1f,
                        Width = 0.30f,
                        Color = Color(red: 20, green: 1, blue: 10, alpha: 1),
                    },
                    Trail = new TrailDef
                    {
                        Enable = false,
                        Material = "WeaponLaser",
                        DecayTime = 30,
                        Color = Color(red: 20, green: 8, blue: 20, alpha: 8),
                        Back = false,
                        CustomWidth = 0.30f,
                        UseWidthVariance = true,
                        UseColorFade = true,
                    ...
                    OffsetEffect = new OffsetEffectDef
                    {
                        MaxOffset = 0.4f,// 0 offset value disables this effect
                        MinLength = 1f,
                        MaxLength = 10f,
                    },
                },
        ...
        private AmmoDef XB1PulseCharge => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "XB1PulseCharge",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0.75f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 3000f,
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 6f,
                        Width = 0.3f,
                        Color = Color(red: 0, green: 20, blue: 20, alpha: 1),
                    },
                    Trail = new TrailDef
                    {
                        Enable = true,
        ...
        private AmmoDef XB3PulseCharge => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "XB3PulseCharge",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 1.0f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 10000f,
            Mass = 0f, // in kilograms
            Health = 0, // 0 = disabled, otherwise how much damage it can take from other trajectiles before dying.
            BackKickForce = 0f,
        ...
        private AmmoDef LaserCharge => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "LaserCharge",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            ...
            {
                AreaEffect = Radiant, // Disabled = do not use area effect at all, Explosive, Radiant, AntiSmart, JumpNullField, JumpNullField, EnergySinkField, AnchorField, EmpField, OffenseField, NavField, DotField.
                AreaEffectDamage = 10, // 0 = use spillover from BaseDamage, otherwise use this value.
                AreaEffectRadius = 2f,
                Pulse = new PulseDef // interval measured in game ticks (60 == 1 second), pulseChance chance (0 - 100) that an entity in field will be hit
                {
                    Interval = 60,
        ...
        private AmmoDef PDCharge => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "LaserCharge",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            ...
            {
                AreaEffect = Disabled, // Disabled = do not use area effect at all, Explosive, Radiant, AntiSmart, JumpNullField, JumpNullField, EnergySinkField, AnchorField, EmpField, OffenseField, NavField, DotField.
                AreaEffectDamage = 150, // 0 = use spillover from BaseDamage, otherwise use this value.
                AreaEffectRadius = 2f,
                Pulse = new PulseDef // interval measured in game ticks (60 == 1 second), pulseChance chance (0 - 100) that an entity in field will be hit
                {
                    Interval = 60,
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 4f,
                        Width = 0.1f,
                        Color = Color(red: 0, green: 5, blue: 10, alpha: 1),
                    },
                    Trail = new TrailDef
                    {
                        Enable = true,
        ...
        private AmmoDef PDChdargeBlue => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "PDChargeBlue",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0.1f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel 1.25f
            BaseDamage = 15,
            Mass = 0.0f, // in kilograms
            Health = 0, // 0 = disabled, otherwise how much damage it can take from other trajectiles before dying.
            BackKickForce = 0f,
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    Hit = new ParticleDef
                    {
                        ...
                        ApplyToShield = true,
                        ShrinkByDistance = false,
                        Color = Color(red: 0, green: 50, blue: 50, alpha: 2),
                        Offset = Vector(x: 0, y: 0, z: 0),
                        Extras = new ParticleOptionDef
                        {
                            Loop = false,
                ...
                Lines = new LineDef
                {
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Material = "WeaponLaser",
                        DecayTime = 2,
                        Color = Color(red: 0, green: 10, blue: 20, alpha: 1),
                        Back = false,
                        CustomWidth = 0.10f,
                        UseWidthVariance = true,
                        UseColorFade = true,
        ...
        private AmmoDef PDChargeBlue => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "PDChargeBlue",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    TracerMaterial = "MexLaser", // WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
