...
{   // Don't edit above this line
    ...
    {
        WeaponDefinition XB1PulseBattery => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[]
                {
                    new MountPointDef
                    {
                        SubtypeId = "XB1PulseBattery",
                        AimPartId = "muzzle_missile_001",
            ...
            {
                WeaponName = "XB1 Pulse", // name of weapon in terminal
                ...
                Loading = new LoadingDef
                {
                    ...
                    Cooldown = .277f, //percent of max heat to be under to start firing again after overheat accepts .2-.95
                ...
                {
                    PreFiringSound = "",
                    FiringSound = "XB1Pulse", // WepShipGatlingShot
            ...
            Ammos = new[] { XB1PulseCharge },
            Animations = XB1Pulse_Animation,
        };
    }
}
