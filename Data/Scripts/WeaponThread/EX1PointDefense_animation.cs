...
{ // Don't edit above this line
    ...
    {
        private AnimationDef EX1PointDefense_Animation => new AnimationDef
        {
            Emissives = new []
            {
                ...
                Emissive(
                    ...
                    Colors: new []
                    {
                        Color(red:0.05f, green: .021f, blue:0, alpha: .05f),//will transitions form one color to the next if more than one
                        Color(red:0, green: 0, blue: 0, alpha: 1),//will transitions form one color to the next if more than one
                ...
                Emissive(
                    ...
                    {
                        Color(red:0.05f, green: .021f, blue:0, alpha: .05f),//will transitions form one color to the next if more than one
                        Color(red:1f, green: .21f, blue:0, alpha: 1),
